  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <header className="hidden">
        <div className="mx-auto flex h-16 max-w-screen-2xl items-center gap-6 px-4 sm:px-6 lg:px-10">
          <Link to="/" className="flex items-center gap-2">
            <div className="grid h-9 w-9 place-items-center rounded-md bg-primary font-bold text-primary-foreground shadow-sm">
              TL
            </div>
      ...
      <footer className="border-t bg-muted/40">
        <div className="mx-auto grid max-w-screen-2xl gap-8 px-4 py-12 sm:px-6 md:grid-cols-4 lg:px-10">
          <div>
        ...
        <div className="border-t">
          <div className="mx-auto flex max-w-screen-2xl flex-col gap-2 px-4 py-4 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-10">
