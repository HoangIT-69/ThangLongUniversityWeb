...
export function StatCard({ label, value, hint, icon: Icon, tone = "primary" }: {
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border bg-card p-5 shadow-sm">
      <div className={`pointer-events-none absolute -right-8 -top-8 h-32 w-32 rounded-full bg-gradient-to-br ${toneClass} blur-2xl`} />
      <div className="relative flex items-start justify-between">
        ...
        {Icon && (
          <div className={`grid h-10 w-10 place-items-center rounded-lg bg-gradient-to-br ${toneClass}`}>
