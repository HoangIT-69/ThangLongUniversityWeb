...
export const notifications: Notification[] = [
  {
    id: "n1",
    type: "INFO",
    title: "Lịch thi học kỳ 1 đã được cập nhật",
    body: "Lịch thi chính thức học kỳ 1 năm học 2024-2025 đã được công bố. Vui lòng kiểm tra lịch thi của bạn.",
  ...
  },
  {
    id: "n2",
    type: "WARNING",
    title: "Hạn đóng học phí: còn 3 ngày",
    body: "Học phí học kỳ 1 năm 2024-2025 sẽ hết hạn vào ngày 15/01/2025. Vui lòng thanh toán đúng hạn để tránh bị khóa đăng ký.",
  ...
  },
  {
    id: "n3",
    type: "INFO",
    title: "Điểm học kỳ 1 đã được công bố",
    body: "Điểm tổng kết học kỳ 1 năm học 2024-2025 đã được cập nhật. Xem kết quả học tập của bạn.",
    at: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString(),
    read: false,
    link: "/student/academic-results",
  },
  {
    id: "n4",
    type: "SUCCESS",
    title: "Đăng ký học phần thành công",
    body: "Bạn đã đăng ký thành công 5 học phần cho học kỳ 2 năm học 2024-2025.",
  ...
  },
  {
    id: "n5",
    type: "INFO",
    title: "Mở đăng ký học kỳ 2 năm 2024-2025",
    body: "Thời gian đăng ký học phần học kỳ 2 năm học 2024-2025: từ ngày 05/01 đến 25/01/2025.",
  ...
  },
  {
    ...
    body: "Yêu cầu đăng ký học phần INT3401 bị từ chối do lớp đã đầy. Vui lòng chọn lớp học phần khác.",
